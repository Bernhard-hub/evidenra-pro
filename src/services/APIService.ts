...
class APIService {
  ...
  private static modelMappings: Record<string, string> = {
    ...
    'claude-3-7-sonnet': 'claude-3-5-sonnet-20241022', // 3.7 existiert nicht -> 4.5
    'claude-3-5-sonnet-20241022': 'claude-3-5-sonnet-20241022', // Oct 2024 -> Auto-Update
    'claude-3-5-sonnet-20241022': 'claude-3-5-sonnet-20241022', // June 2024 -> Auto-Update
    'claude-3-5-haiku-20241022': 'claude-3-5-haiku-20241022', // Oct 2024 Haiku -> Auto-Update
    'claude-3-sonnet-20240229': 'claude-3-5-sonnet',
    'claude-3-opus-20240229': 'claude-3-5-sonnet', // Opus ist veraltet -> Sonnet 3.5
    'claude-3-haiku-20240307': 'claude-3-5-haiku', // Altes Haiku -> Neues Haiku
  ...
  private static async fetchAnthropicModels(apiKey: string): Promise<any[]> {
    ...
    const knownModels = [
      ...
      },
      {
        ...
        name: 'Claude 3.5 Sonnet (Oct 2024) - RECOMMENDED',
        maxTokens: 8192,
        cost: 0.003
      },
      {
